...
function SMARTBUFF_InitItemList()  
  ...
  S.FoodItems = GetItems({
    ...
    74645, 74646, 74647, 74648, 74649, 74650, 74652, 74653, 74655, 74656, 86069, 86070, 86073, 86074, 81400, 81401, 81402, 81403, 81404, 81405, 81406, 81408, 81409, 81410, 81411, 81412, 81413, 81414,
 	...
 	111441, 111442, 111443, 111444, 111445, 111446, 111447, 111448, 111449, 111450,
 	111451, 111452, 111453, 111454,127991,
 	-- WoD Feasts
 	111457, 111458, 118576,
	});
  ...
  SMARTBUFF_MiscItem12          = GetItemInfo(122298); --"Bodyguard Miniaturization Device"
...
function SMARTBUFF_InitSpellIDs()
  ...
  SMARTBUFF_BMiscItem12     = GetSpellInfo(181642); --"Bodyguard Miniaturization Device"
